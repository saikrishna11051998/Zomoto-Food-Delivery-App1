...
import { Image, KeyboardAvoidingView, Pressable,ScrollView , SafeAreaView, StyleSheet, Text, View,FlatList, TouchableOpacity } from 'react-native'
      ...
      <KeyboardAvoidingView style={{ flex: 1, marginTop: 25 }}>
        ...
        <View style={styles.floatingButton}>
          <TouchableOpacity>
               ...
               <Text style={styles={color:'red'}}>Map</Text>
          </TouchableOpacity>
        </View>
